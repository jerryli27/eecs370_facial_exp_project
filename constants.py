...
PHOTO_DISPLAY_HEIGHT = (GAME_SCREEN_HEIGHT - BATTLE_SCREEN_HEIGHT) * 2 / 4 - 5  # 5 for buffer between hp bar and image.
...
HP_BAR_FULL_LENGTH = 100
HP_BAR_HEIGHT = 20
HP_BAR_DEAFY_BOTTOMLEFT = (GAME_SCREEN_WIDTH * 3 / 32, GAME_SCREEN_HEIGHT * 7 / 8)
HP_BAR_CAT_BOTTOMLEFT = (GAME_SCREEN_WIDTH * 3 / 4, GAME_SCREEN_HEIGHT * 7 / 8)

FACE_ILLUS_WIDTH = GAME_SCREEN_WIDTH / 8
FACE_ILLUS_HEIGHT = GAME_SCREEN_HEIGHT / 8
FACE_DEAFY_BOTTOMLEFT = (HP_BAR_DEAFY_BOTTOMLEFT[0] + HP_BAR_FULL_LENGTH + GAME_SCREEN_WIDTH / 32,
